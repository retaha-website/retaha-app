// Sprint E2 · Phase 6 — Manual-Refresh für Nearby-Cache (Hotelier-Trigger)
//
// POST /api/admin/places/refresh-nearby  body: { category?: 'restaurant' | ... | 'all' }
//
// Hotelier kann im /admin/places UI Auto-Empfehlungen für eine einzelne
// Kategorie oder alle 5 manuell refreshen — z.B. nach Hotel-Adress-Update
// oder weil ein neues Restaurant in der Nähe aufgemacht hat.
...
export const POST: APIRoute = async ({ cookies, request }) => {
  ...
  // Category-Resolution: 'all' / undefined → alle 5, sonst nur die eine
