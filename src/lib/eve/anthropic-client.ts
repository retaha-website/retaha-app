...
/**
 * Streaming-Variante — Stub bis Phase 8 (Streaming-Endpoint /api/eve/chat).
 *
 * Phase 2 bleibt synchron (eveComplete reicht für Wrapper-Test + Router +
 * System-Prompt-Builder). Sobald Phase 8 anfängt, implementieren wir hier
 * client.messages.stream() mit AsyncIterator + Server-Sent-Events-Yield.
 */
export async function* eveStreamComplete(_params: EveCompletionParams) {
  throw new Error('eveStreamComplete: not implemented yet — Phase 8 baut den Streaming-Endpoint');
