// POST /api/loyalty/validate — Hotelier prüft/löst einen Gutschein am Empfang ein.
// Auth: getUserHotels (Hotel-Besitz). action 'lookup' (nur ansehen) | 'redeem'
// (issued → validated). Write: Service-Role (loyalty_redemptions ist RLS-locked).
