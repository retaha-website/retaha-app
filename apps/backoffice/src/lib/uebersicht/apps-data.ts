...
export const APPS: SetupApp[] = [
  { id: 1, num: '01', label: 'Hotel-Daten',  sub: 'Name · Adresse',
    activeAt: 0,  doneAt: 30,  sticker: { todo: 'WAIT', active: 'START', done: 'DONE'   }, href: '/admin/settings'    },
  { id: 2, num: '02', label: 'Branding',     sub: 'Farben · Schrift',
    activeAt: -1, doneAt: 30,  sticker: { todo: 'WAIT', active: 'START', done: 'DONE'   }, href: '/admin/settings'    },
