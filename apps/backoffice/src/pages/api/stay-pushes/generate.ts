...
export const POST: APIRoute = async ({ cookies, request }) => {
  ...
  const prompt = `Du bist Experte für Hotel-Kommunikation und Wallet-Push-Nachrichten.
...
Die Texte erscheinen als Push-Nachrichten auf dem Smartphone des Gastes via Apple Wallet oder Google Wallet.
Tonalität: Warm, persönlich, gastorientiert — keine generischen Textbausteine.
Platzhalter dürfen verwendet werden: {{first_name}}, {{hotel_name}}, {{room_number}}, {{service_name}}, {{checkout_time}}, {{spa_service_name}}.
