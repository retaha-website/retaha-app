// Backoffice · Marketing — Drip-Sequenz Update / Activate-Toggle / Delete
//
// PUT    /api/marketing/drips/[id]    → update name/config/is_active
// DELETE /api/marketing/drips/[id]    → hard delete (cascades zu Steps + State)
