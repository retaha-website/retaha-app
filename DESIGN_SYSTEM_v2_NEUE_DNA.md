# retaha · design-system v2

> **status:** marken-revolution abgeschlossen am 25.05.2026. alte bauhaus/burgund/cream-dna verworfen, neue dna festgelegt. dieses dokument ist die single source of truth für die migration.

> **verhältnis zum alten styleguide:** `APP_STYLEGUIDE.md` enthält noch die alte dna mit burgund/sage/bone/cream. dieses dokument **überschreibt** die marken-dna und alle komponenten-tokens. die existierende komponenten-architektur (BauhausToggle, BauhausPill, BauhausButton etc.) bleibt strukturell erhalten, nur farben + sizing werden migriert.

> **was bleibt aus dem alten system:** bauhaus-status-vokabular (kreis/quadrat/linie/dreieck), all-lowercase-prinzip, manufaktur-stimme, iteratives design, asymmetrische komposition.
